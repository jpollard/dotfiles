...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "circe" '("circe-" "with-circe-server-buffer")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "circe-display-images" '("circe-" "remove-circe-display-images" "add-circe-display-images" "disable-circe-display-images")))
